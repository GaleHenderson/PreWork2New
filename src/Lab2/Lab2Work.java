...
public class Lab2Work {
	...
	public static void main(String[] args) {
		//Defines string variables for date inputs
		String dateToday; 
        String dateBirth;
        
		Scanner scnr = new Scanner(System.in);
	      
	      //This will prompt user for date inputs 
        ...
        //Prints the time between the two dates in years, months, and days
         System.out.println("Wow..." + Math.abs(timeBetween.getYears()) + " year(s), " + Math.abs(timeBetween.getMonths()) + " month(s), and " + Math.abs(timeBetween.getDays()) + " day(s) between " + dateBirth + " and " + dateToday + "have elapsed since you were born!");
